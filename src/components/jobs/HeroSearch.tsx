        ...
        <div className="p-6 mb-8 ">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-2 mb-6">
                <div className="flex flex-col md:flex-row md:items-center divide-y md:divide-y-0 md:divide-x divide-gray-100">
                    ...
                    <div className="p-2">
                        <button className="w-full md:w-auto bg-main-blue hover:bg-main-blue/80 text-white px-8 py-2.5 rounded-lg font-medium transition-colors flex items-center justify-center gap-2">
